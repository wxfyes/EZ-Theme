// 外部配置文件 - 支持注释和说明
// 此文件可以手动修改，修改后刷新页面即可生效
// 如需恢复默认配置，请删除此文件

window.__EXTERNAL_CONFIG__ = {
  // ==================== 面板类型配置 ====================
...
// 配置加载完成后的回调
if (typeof window.__CONFIG_LOADED__ === 'function') {
  window.__CONFIG_LOADED__(window.__EXTERNAL_CONFIG__);
}

console.log('✅ 外部配置加载完成');